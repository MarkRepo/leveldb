 ...
 public:
  ...
  class Reporter {
   public:
    ...
    // Some corruption was detected.  "size" is the approximate number of bytes dropped due to the corruption.
  ...
  // Read the next record into *record.  Returns true if read successfully, false if we hit end of the input.  
  // May use "*scratch" as temporary storage.  
  // The contents filled in *record will only be valid until the next mutating operation on this
